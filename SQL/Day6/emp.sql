...
('Arun Kumar', 'IT', 65000, 'Software Developer'),
('Deepika R', 'HR', 48000, 'HR Executive'),
('Sanjay M', 'Finance', 72000, 'Accountant'),
('Kathiravan S', 'IT', 85000, 'Senior Developer'),
('Meena P', 'Marketing', 55000, 'Content Strategist'),
('Vignesh K', 'Finance', 63000, 'Financial Analyst'),
('Harini S', 'IT', 40000, 'Intern Developer'),
('Ragul R', 'Marketing', 70000, 'Digital Marketer'),
('Nisha L', 'HR', 52000, 'Recruiter'),
('Praveen T', 'IT', 90000, 'Team Lead'),
